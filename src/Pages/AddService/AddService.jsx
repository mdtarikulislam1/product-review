...
const handleSubmit = (e) => {
  ...
  return (
   ...
   />
        ...
        <input required className='h-auto p-2 text-gray-900 bg-white rounded-sm dark:bg-gray-800 dark:text-gray-100 w-72 ' type='text' name="title" placeholder='Title'/>
      </div>
        <div>
       ...
       ></textarea>
        ...
        <input required className='h-auto p-2 bg-white rounded-sm dark:bg-gray-800 dark:text-gray-100 w-72 ' type="text" name="company" placeholder='Company Name'/>
      </div>
        <div>
          <p className='py-2 text-lg text-gray-600 dark:text-gray-400'>Website</p>
        <input required className='p-2 bg-white rounded-sm w-72 dark:bg-gray-800 dark:text-gray-100' type="url" name="website" placeholder='Website'/>
      </div>
        <div>
          <p className='py-2 text-lg text-gray-600 dark:text-gray-400'>Category</p>
        <input required className='p-2 bg-white rounded-sm w-72 dark:bg-gray-800 dark:text-gray-100' type="text" name="category" placeholder='Category'/>
      </div>
        <div>
          <p className='py-2 text-lg text-gray-600 dark:text-gray-400'>Price</p>
        <input required className='p-2 bg-white rounded-sm w-72 dark:bg-gray-800 dark:text-gray-100' type="number" name="price" placeholder='Price'/>
      </div>
        <div>
          <p className='py-2 text-lg text-gray-600 dark:text-gray-400'>Date</p>
        <input required className='p-2 bg-white rounded-sm w-72 dark:bg-gray-800 dark:text-gray-100' type="text" name="date"   value={today}
        readOnly/>
      </div>
        <div>
          <p className='py-2 text-lg text-gray-600 dark:text-gray-400'>Email</p>
        <input required className='p-2 bg-white rounded-sm w-72 dark:bg-gray-800 dark:text-gray-100' type="text" name="email"   value={user?.email|| ""}
        readOnly />
      </div>
      </div>
        <div><button  className='w-full py-2 my-4 text-xl font-semibold text-center text-white bg-black rounded-lg text' type="submit">Add Service</button></div>
    </form>
    </motion.div>
  )
}
