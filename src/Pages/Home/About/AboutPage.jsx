...
export default function AboutPage() {
  return (
    <div className="px-6 py-16 space-y-20 text-gray-800 bg-gray-50 dark:text-white dark:bg-neutral-800 md:px-20">
      ...
      >
        <h1 className="text-xl font-bold">About Our Service</h1>
      ...
      <motion.div
        ...
        variants={fadeInUp}
        className="p-10 rounded-2xl dark:bg-neutral-800"
      >
        <h2 className="mb-8 text-xl font-semibold text-center">Why Choose Us?</h2>
