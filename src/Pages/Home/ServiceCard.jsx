...
const fadeInUp = {
  ...
  return (
   <div className='maxWidth'> 
    <h2 className='text-xl font-bold text-center dark:text-white'><span className='text-yellow-500'>Featured</span> Services</h2>
     <div className="grid grid-cols-1 gap-4 my-10 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">
